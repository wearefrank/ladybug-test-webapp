...
public class ServletListener implements ServletContextListener {
	...
	public void contextInitialized(ServletContextEvent servletContextEvent) {
		...
		String name = "LadybugFrontendServlet";
		String mapping = FrontendServlet.getDefaultMapping();
		logger.info("Registering servlet with name [" + name + "] with mapping [" + mapping + "]");
		ServletRegistration.Dynamic servletRegistration = context.addServlet(name, FrontendServlet.class);

...
<%@ page import="nl.nn.testtool.storage.database.DatabaseStorage"%>
...
<%
	...
	if ("true".equals(request.getParameter("clearDatabaseStorage"))) {
		DatabaseStorage databaseStorage = (DatabaseStorage)webApplicationContext.getBean("databaseStorage");
